    ...
    <PageLayout>
      ...
      <section className="relative py-24 md:py-32 bg-[#001f3f] text-white overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10 text-center">
          <h1 className="text-3xl md:text-4xl font-semibold mb-6  tracking-tight leading-tight">Our Mission & Vision</h1>
          <div className="h-2 w-24 md:w-32 bg-[#facc15] mx-auto mb-8"></div>
          <p className="text-base md:text-base text-[#facc15] font-semibold  tracking-widest max-w-3xl mx-auto">
      ...
      <SectionWrapper>
        <div className="grid md:grid-cols-2 gap-8 md:gap-16">
          <div className="bg-white p-8 md:p-12 shadow-lg border-l-8 border-[#facc15]">
            <h2 className="text-2xl md:text-3xl font-semibold text-[#001f3f] mb-6  tracking-wider">Our Mission</h2>
            <p className="text-base md:text-base text-gray-600 leading-relaxed italic">
              "To provide the best and most suitable medical aid to communities and persons in need."
            </p>
          </div>
          <div className="bg-[#001f3f] p-8 md:p-12 shadow-lg border-l-8 border-[#facc15] text-white">
            <h2 className="text-2xl md:text-3xl font-semibold mb-6  tracking-wider">Our Vision</h2>
            <p className="text-base md:text-base text-white/80 leading-relaxed italic">
      ...
      <SectionWrapper className="bg-gray-50">
        <div className="max-w-4xl mx-auto text-center mb-12 md:mb-16">
          <h2 className="text-2xl md:text-3xl font-semibold text-[#001f3f] mb-8 ">Who We Are</h2>
          <p className="text-base md:text-base text-gray-600 leading-relaxed mb-8">
      ...
      <SectionWrapper>
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-xs md:text-sm font-semibold text-[#facc15]  tracking-widest mb-2">Our Foundation</h2>
          <h3 className="text-xl md:text-2xl font-semibold text-[#001f3f] mb-4 ">Core Values</h3>
          <div className="h-1.5 w-24 bg-[#facc15] mx-auto"></div>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 md:gap-8">
          {coreValues.map((value, index) => (
            <div key={index} className="text-center p-6 md:p-8 bg-white shadow-md hover:shadow-lg transition-colors transition-transform transition-shadow border-b-4 border-[#facc15]">
              <div className="text-[#001f3f] text-base md:text-base font-semibold mb-4 ">{value.name}</div>
      ...
      <SectionWrapper className="bg-[#001f3f] text-white">
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          <div>
            <h2 className="text-2xl md:text-3xl font-semibold mb-8  text-center md:text-left">Get In Touch</h2>
            <div className="space-y-6 md:space-y-8">
              <div className="flex items-start gap-4">
                <MapPin className="text-[#facc15] mt-1 shrink-0" size={24} />
                <div>
                  <h4 className="font-semibold  tracking-wider text-lg md:text-xl mb-1">Address</h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-semibold  tracking-wider text-lg md:text-xl mb-1">Phone</h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-semibold  tracking-wider text-lg md:text-xl mb-1">Email</h4>
                  <p className="text-xs md:text-base text-white/70">contact@volunteermedicalcorps.org</p>
                </div>
              </div>
            </div>
          </div>
          <div className="bg-white p-6 md:p-10 shadow-lg text-[#001f3f]">
            ...
            <div className="space-y-4">
              ...
              <Button className="w-full bg-[#001f3f] hover:bg-[#002855] text-white rounded-none py-6 md:py-8 font-semibold  tracking-widest text-xs md:text-sm uppercase">
                Send Message
              </Button>
            </div>
          </div>
