    ...
    <>
      ...
      <SectionWrapper className="bg-white">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-sm font-bold text-[#facc15] uppercase tracking-widest mb-2">About Us</h2>
            <h3 className="text-4xl md:text-5xl font-black text-[#001f3f] mb-6 uppercase">The Fastest Growing Outreach</h3>
      ...
      <SectionWrapper className="bg-gray-50">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 md:order-2">
            ...
            <h3 className="text-4xl md:text-5xl font-black text-[#001f3f] mb-6 uppercase">Global Network of Care</h3>
            <div className="h-1 w-20 bg-[#facc15] mb-8"></div>
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
