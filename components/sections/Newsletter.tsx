    ...
    <SectionWrapper className="bg-[#facc15] py-16 md:py-16">
      <div className="flex flex-col md:flex-row items-center justify-between gap-8">
        <div className="md:w-1/2">
          <h2 className="text-3xl font-black text-[#001f3f] mb-2">SUBSCRIBE TO OUR NEWSLETTER</h2>
        ...
        <div className="w-full md:w-1/2">
          <form className="flex w-full max-w-md ml-auto">
            <Input 
              ...
              required
            />
            <Button type="submit" className="bg-[#001f3f] hover:bg-[#002855] text-white h-14 px-8 rounded-none font-black tracking-widest uppercase">
              Subscribe
            </Button>
          </form>
        </div>
